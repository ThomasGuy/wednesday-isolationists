...
function Biography() {
  const data = useStaticQuery(SuzanneQUERY);
  ...
  return (
    <Layout
      title="Suzanne Ewart"
      description="artist painter graphic design illustrator">
      <Grid>
        <Row>
          <Image>
            ...
            <ul>
              ...
              <li>
                <a
                  ...
                  href="http://www.instagram.com/suzanne.ewart">
                  <img
